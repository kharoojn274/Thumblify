...
const StyleSelector = ({
  ...
  const styleIcons: Record<ThumbnailStyle, React.ReactNode> = {
    ...
    "Hand-drawn": <PenToolIcon className="h-4 w-4" />,
    ...
    <div className="relative space-y-3 dark">
     ...
     text-zinc-200"
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-md border px-4 py-3 text-left transition bg-white/8
       border-white/10 text-zinc-200 hover:bg-white/12"
      >
